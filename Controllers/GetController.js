...
const GetHotelDetails = async (req, res) => {
  ...
  console.log(PropertyCode);
  let coverimage = await File.find({ PropertyCode: PropertyCode });
  let propertyimage = await File.find({ PropertyCode: PropertyCode });
  let abouthotel = await Property.find({ Propertycode: PropertyCode });
  let amenitiesmaster = await AmenitiesMaster.find({
    PropertyCode: PropertyCode,
  }); //yet tocreate schema
  let roomtypes = await Roomtype.find({ PropertyCode: PropertyCode });
  ...
  console.log("coverimage");
  // console.log(coverimage[0].CoverImage[0])
  console.log(coverimage[0]);
  console.log("propertyimage");
  console.log(propertyimage.length);
  console.log(propertyimage[0]);
  console.log(propertyimage[1]);
  console.log(propertyimage[2]);
  console.log("abouthotel");
  // console.log(abouthotel)
  console.log(abouthotel.Propertydescription);
  // console.log("amenitiesmaster")
  // console.log(amenitiesmaster);
  // console.log(amenitiesmaster[0]);
  // console.log(amenitiesmaster[0].type);
  // console.log(`amenitiesmaster[0]['type']${amenitiesmaster[0]['type']}`)
  // console.log(`amenitiesmaster[0]:${amenitiesmaster[0]}`)
  //----------------------------------------------------------------------------------------
  // console.log(`amenitiesmaster[0]['Barbeque']${amenitiesmaster[0]['Barbeque']}`)
  // console.log(`amenitiesmaster[0]['Breakfast']${amenitiesmaster[0]['Breakfast']}`)
  // console.log(`amenitiesmaster[0]['Cafe']${amenitiesmaster[0]['Cafe']}`)
  // console.log(`amenitiesmaster[0]['Housekeeping']${amenitiesmaster[0]['Housekeeping']}`)
  // console.log(`amenitiesmaster[0]['LAN']${amenitiesmaster[0]['LAN']}`)
  // console.log(`amenitiesmaster[0]['Washing Machine']${amenitiesmaster[0]['Washing Machine']}`)
  // console.log(`amenitiesmaster[0]['EV Charging Station']${amenitiesmaster[0]['EV Charging Station']}`)
  // console.log(`amenitiesmaster[0]['Bonfire Pit']${amenitiesmaster[0]['Bonfire Pit']}`)
  // console.log(`amenitiesmaster[0]['Prayer Room']${amenitiesmaster[0]['Prayer Room']}`)
  // console.log(`amenitiesmaster[0]['Seating Area']${amenitiesmaster[0]['Seating Area']}`)
  // console.log(`amenitiesmaster[0]['Terrace']${amenitiesmaster[0]['Terrace']}`)
  var amenitieslist = [];
  if (amenitiesmaster[0]["Barbeque"] == "yes") {
    amenitieslist.push("Barbeque");
  }
  if (amenitiesmaster[0]["Breakfast"] == "yes") {
    amenitieslist.push("Breakfast");
  }
  if (amenitiesmaster[0]["Cafe"] == "yes") {
    amenitieslist.push("Cafe");
  }
  if (amenitiesmaster[0]["Housekeeping"] == "yes") {
    amenitieslist.push("Housekeeping");
  }
  if (amenitiesmaster[0]["LAN"] == "yes") {
    amenitieslist.push("LAN");
  }
  if (amenitiesmaster[0]["Washing Machine"] == "yes") {
    amenitieslist.push("Washing Machine");
  }
  if (amenitiesmaster[0]["EV Charging Station"] == "yes") {
    amenitieslist.push("EV Charging Station");
  }
  if (amenitiesmaster[0]["Bonfire Pit"] == "yes") {
    amenitieslist.push("Bonfire Pit");
  }
  if (amenitiesmaster[0]["Prayer Room"] == "yes") {
    amenitieslist.push("Prayer Room");
  }
  if (amenitiesmaster[0]["Seating Area"] == "yes") {
    amenitieslist.push("Seating Area");
  }
  if (amenitiesmaster[0]["Terrace"] == "yes") {
    amenitieslist.push("Terrace");
  }
  ...
  /*console.log(abouthotel[0].Propertydescription)*/
  ...
  let jsondata = {
    Propertyname: abouthotel[0].Propertyname,
    Propertydescription: abouthotel[0].Propertydescription,
    Propertyaddress: abouthotel[0].Propertyaddress,
    coverimage: coverimage[0].CoverImage[0],
    Roomtypes: roomtypes,
    rates: rates,
